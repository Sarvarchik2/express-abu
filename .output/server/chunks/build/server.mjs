import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, unref, ref, computed, defineComponent, h, Fragment, createVNode, Text, Suspense, nextTick, mergeProps, provide, watch, resolveComponent, withCtx, createTextVNode, toDisplayString as toDisplayString$1, useSSRContext, createBlock, createCommentVNode, openBlock, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from 'vue';
...
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
...
const _routes = [
  {
    ...
    component: () => import('./access-denied.vue.mjs')
  },
  {
    name: "access-denied___ru",
    path: "/ru/access-denied",
    component: () => import('./access-denied.vue.mjs')
  },
  {
    name: "access-denied___uz",
    path: "/access-denied",
    component: () => import('./access-denied.vue.mjs')
  },
  {
    name: "address___en",
    path: "/en/address",
    component: () => import('./address.vue.mjs')
  },
  {
    name: "address___ru",
    path: "/ru/address",
  ...
  },
  {
    name: "deliver___en",
    path: "/en/deliver",
    component: () => import('./deliver.vue.mjs')
  },
  {
    name: "deliver___ru",
    path: "/ru/deliver",
  ...
  },
  {
    name: "markets___en",
    path: "/en/markets",
    component: () => import('./markets.vue.mjs')
  },
  {
    name: "markets___ru",
    path: "/ru/markets",
  ...
  },
  {
    name: "parcels___en",
    path: "/en/parcels",
    component: () => import('./parcels.vue.mjs')
  },
  {
    name: "parcels___ru",
    path: "/ru/parcels",
  ...
  },
  {
    ...
    component: () => import('./registration.vue.mjs')
  },
  {
  ...
  },
  {
    name: "tarif___en",
    path: "/en/tarif",
    component: () => import('./tarif.vue.mjs')
  },
  {
    name: "tarif___ru",
    path: "/ru/tarif",
...
const localeLoaders = {
  en: [
    {
      key: "locale_en_46json_46879891",
      load: () => import(
        './en.json.mjs'
        /* webpackChunkName: "locale_en_46json_46879891" */
      ),
      cache: true
    }
  ],
  ru: [
    {
      key: "locale_ru_46json_41318e6d",
      load: () => import(
        './ru.json.mjs'
        /* webpackChunkName: "locale_ru_46json_41318e6d" */
      ),
      cache: true
    }
  ],
  uz: [
    {
      key: "locale_uz_46json_c263f846",
      load: () => import(
        './uz.json.mjs'
        /* webpackChunkName: "locale_uz_46json_c263f846" */
      ),
      cache: true
    }
  ]
...
const normalizedLocales = [
  {
    ...
    files: [
      {
        path: "/Users/sarubola/Documents/express-abu/i18n/locales/en.json",
        cache: void 0
      }
    ]
  },
  {
    ...
    files: [
      {
        path: "/Users/sarubola/Documents/express-abu/i18n/locales/ru.json",
        cache: void 0
      }
    ]
  },
  {
    ...
    files: [
      {
        path: "/Users/sarubola/Documents/express-abu/i18n/locales/uz.json",
        cache: void 0
      }
    ]
  }
...
function createCoreContext(options = {}) {
  ...
  const version = isString(options.version) ? options.version : VERSION$2;
...
const TranslationImpl = /* @__PURE__ */ defineComponent({
  ...
  setup(props, context) {
    ...
    return () => {
      ...
      const tag = isString(props.tag) || isObject(props.tag) ? props.tag : getFragmentableTag$1();
...
const Exit = "data:image/webp;base64,";

const Logo = "" + __buildAssetsURL("logo.Dk0MFiUH.png");

const Calc = "data:image/webp;base64,";

const Lang = "data:image/webp;base64,";

const Menu = "data:image/png;base64,";

const Profile = "data:image/png;base64,";

const En = "" + __buildAssetsURL("united-states.6DoKUpcr.png");

const Uz = "data:image/png;base64,";

const Ru = "data:image/png;base64,";
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<nav${ssrRenderAttrs(mergeProps({ class: "navbar" }, _attrs))} data-v-33ee88ab><div class="navbar-left" data-v-33ee88ab><div class="logo" data-v-33ee88ab><img${ssrRenderAttr("src", unref(Logo))} alt="abu express logo" data-v-33ee88ab></div><ul data-v-33ee88ab><li data-v-33ee88ab>`);
      if (userRole.value === "delivery") {
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: unref(localePath)("/deliver"),
          class: "delivery-btn"
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(_ctx.$t("deli"))}`);
            } else {
              return [
                createTextVNode(toDisplayString$1(_ctx.$t("deli")), 1)
              ];
            }
          }),
          _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createTextVNode(toDisplayString$1(_ctx.$t("main")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(`</li><li data-v-33ee88ab>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: unref(localePath)("/tarif")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("tarif"))}`);
          } else {
            return [
              createTextVNode(toDisplayString$1(_ctx.$t("tarif")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(`</li><li data-v-33ee88ab>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: unref(localePath)("/markets")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("markets"))}`);
          } else {
            return [
              createTextVNode(toDisplayString$1(_ctx.$t("markets")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createTextVNode(toDisplayString$1(_ctx.$t("services")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createTextVNode(toDisplayString$1(_ctx.$t("contact")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createTextVNode(toDisplayString$1(_ctx.$t("help")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</li></ul></div><div class="navbar-right" data-v-33ee88ab><div class="navbar-calck-btn" data-v-33ee88ab><img${ssrRenderAttr("src", unref(Calc))} alt="calc" data-v-33ee88ab></div><div class="navbar-lang-btn" data-v-33ee88ab><img${ssrRenderAttr("src", unref(Lang))} alt="lang" data-v-33ee88ab>`);
      if (showDropdown.value) {
        _push(`<ul class="navbar-lang-btn-wrapper" data-v-33ee88ab><li data-v-33ee88ab><img${ssrRenderAttr("src", unref(Uz))} alt="" data-v-33ee88ab></li><li data-v-33ee88ab><img${ssrRenderAttr("src", unref(Ru))} alt="" data-v-33ee88ab></li><li data-v-33ee88ab><img${ssrRenderAttr("src", unref(En))} alt="" data-v-33ee88ab></li></ul>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><button class="navbar-lang-btn" data-v-33ee88ab><img${ssrRenderAttr("src", unref(Profile))} alt="profile" data-v-33ee88ab></button><img class="nav-menu-btn"${ssrRenderAttr("src", unref(Menu))} alt="menu" data-v-33ee88ab></div><div class="${ssrRenderClass([{ "navbar-mobile-active": isMenuOpen.value }, "navbar-mobile"])}" data-v-33ee88ab><img class="navbar-mobile-img"${ssrRenderAttr("src", unref(Exit))} alt="exit" data-v-33ee88ab><ul data-v-33ee88ab><li data-v-33ee88ab>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        onClick: closeMenu,
        to: unref(localePath)("/")
      }, {
      ...
      _push(`</li></ul><div class="navbar-link" data-v-33ee88ab>`);
      if (userRole.value === "delivery") {
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: unref(localePath)("/deliver"),
          class: "delivery-btn"
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createTextVNode(toDisplayString$1(_ctx.$t("tarif_registration")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("tarif_login"))}`);
          } else {
            return [
              createTextVNode(toDisplayString$1(_ctx.$t("tarif_login")), 1)
            ];
          }
        }),
        _: 1
      ...
      if (showCalculator.value) {
        _push(`<div class="calculator" data-v-33ee88ab><div class="calculator-wrapper" data-v-33ee88ab><div class="calculator-wrapper-title" data-v-33ee88ab><h2 data-v-33ee88ab>${ssrInterpolate(_ctx.$t("tarif_calculator"))}</h2><img${ssrRenderAttr("src", unref(Exit))} alt="close" data-v-33ee88ab></div><div class="calculator-wrapper-bottom" data-v-33ee88ab><div class="calculator-wrapper-item-wrapper" data-v-33ee88ab><div class="calculator-wrapper-item" data-v-33ee88ab><label for="from" data-v-33ee88ab>${ssrInterpolate(_ctx.$t("calculator_from"))}</label><select id="from" data-v-33ee88ab><option value="USA" data-v-33ee88ab${ssrIncludeBooleanAttr(Array.isArray(from.value) ? ssrLooseContain(from.value, "USA") : ssrLooseEqual(from.value, "USA")) ? " selected" : ""}>${ssrInterpolate(_ctx.$t("calculator_us"))}</option><option value="China" data-v-33ee88ab${ssrIncludeBooleanAttr(Array.isArray(from.value) ? ssrLooseContain(from.value, "China") : ssrLooseEqual(from.value, "China")) ? " selected" : ""}>${ssrInterpolate(_ctx.$t("calculator_china"))}</option><option value="Turkey" data-v-33ee88ab${ssrIncludeBooleanAttr(Array.isArray(from.value) ? ssrLooseContain(from.value, "Turkey") : ssrLooseEqual(from.value, "Turkey")) ? " selected" : ""}>${ssrInterpolate(_ctx.$t("calculator_turkey"))}</option></select></div><div class="calculator-wrapper-item" data-v-33ee88ab><label for="to" data-v-33ee88ab>${ssrInterpolate(_ctx.$t("calculator_where"))}</label><select id="to" data-v-33ee88ab><option value="UZB" data-v-33ee88ab${ssrIncludeBooleanAttr(Array.isArray(to.value) ? ssrLooseContain(to.value, "UZB") : ssrLooseEqual(to.value, "UZB")) ? " selected" : ""}>UZB</option></select></div></div><div class="calculator-wrapper-item" data-v-33ee88ab><label for="weight" data-v-33ee88ab>${ssrInterpolate(_ctx.$t("calculator_weight"))}</label><input type="number" id="weight"${ssrRenderAttr("value", weight.value)} min="0" placeholder="0" data-v-33ee88ab><select data-v-33ee88ab><option value="KG" data-v-33ee88ab${ssrIncludeBooleanAttr(Array.isArray(unit.value) ? ssrLooseContain(unit.value, "KG") : ssrLooseEqual(unit.value, "KG")) ? " selected" : ""}>KG</option><option value="LB" data-v-33ee88ab${ssrIncludeBooleanAttr(Array.isArray(unit.value) ? ssrLooseContain(unit.value, "LB") : ssrLooseEqual(unit.value, "LB")) ? " selected" : ""}>LB</option></select></div><button class="calculate-btn" data-v-33ee88ab>${ssrInterpolate(_ctx.$t("calculator_calculate"))}</button><h3 data-v-33ee88ab>${ssrInterpolate(_ctx.$t("calculator_total"))} ${ssrInterpolate(total.value)}$</h3></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</nav>`);
...
const Navbar = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-33ee88ab"]]);

const Time = "data:image/png;base64,";

const Point = "data:image/png;base64,";

const Mail = "data:image/png;base64,";

const Phone = "data:image/png;base64,";

const Facebook = "data:image/png;base64,";

const Instagram = "data:image/png;base64,";

const Arrow = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABgAAAAZCAYAAAArK+5dAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAABQSURBVHgB7c+xCUAhDATQC/xBv5PoKG7iaNEUopWIqFjcA63CXQIQXaGqvz2coo3HCSU4sOS5klQbsJtt3V0QsBPDRwXL4d/knLNPRCKIrstsqKHodzSDMgAAAABJRU5ErkJggg==";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_NuxtLink = __nuxt_component_0;
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "footer" }, _attrs))}><div class="footer-top"><div class="footer-top-item"><img${ssrRenderAttr("src", $data.Phone)} alt="asd"><h2>${ssrInterpolate(_ctx.$t("contact_contact"))} <p>+998(95)955-05-55</p></h2></div><div class="footer-top-item"><img${ssrRenderAttr("src", $data.Mail)} alt="asd"><h2>${ssrInterpolate(_ctx.$t("footer_gmail"))} <p>abuexpressl@gmail.com</p></h2></div><div class="footer-top-item"><img${ssrRenderAttr("src", $data.Point)} alt="asd"><h2>${ssrInterpolate(_ctx.$t("footer_location"))} <p>Абу Сулеймана Банакоти 225A, Ташкент, Узбекистан, </p></h2></div><div class="footer-top-item"><img${ssrRenderAttr("src", $data.Time)} alt="asd"><h2>${ssrInterpolate(_ctx.$t("footer_working_hours"))} <p>24/7</p></h2></div></div><div class="footer-bottom"><div class="footer-bottom-left"><img${ssrRenderAttr("src", $data.Logo)} alt="asd"><p>${ssrInterpolate(_ctx.$t("footer_slogan"))}</p><div class="footer-bottom-left-item">`);
  _push(ssrRenderComponent(_component_NuxtLink, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${ssrRenderAttr("src", $data.Facebook)} alt="ad"${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
            src: $data.Facebook,
  ...
  _push(ssrRenderComponent(_component_NuxtLink, { to: "https://www.instagram.com/abu_express_?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${ssrRenderAttr("src", $data.Instagram)} alt="ad"${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
            src: $data.Instagram,
  ...
  _push(`</div></div><div class="footer-bottom-right"><div class="footer-bottom-item"><h2>${ssrInterpolate(_ctx.$t("footer_about"))}</h2><ul><li><img${ssrRenderAttr("src", $data.Arrow)} alt="asd"> ${ssrInterpolate(_ctx.$t("footer_rates"))}</li><li><img${ssrRenderAttr("src", $data.Arrow)} alt="asd"> ${ssrInterpolate(_ctx.$t("footer_services"))}</li><li><img${ssrRenderAttr("src", $data.Arrow)} alt="asd"> ${ssrInterpolate(_ctx.$t("footer_team"))}</li><li><img${ssrRenderAttr("src", $data.Arrow)} alt="asd"> ${ssrInterpolate(_ctx.$t("footer_for_customers"))}</li><li><img${ssrRenderAttr("src", $data.Arrow)} alt="asd"> ${ssrInterpolate(_ctx.$t("footer_useful"))}</li></ul></div><div class="footer-bottom-item"><h2> Покупателям </h2><ul><li><img${ssrRenderAttr("src", $data.Arrow)} alt="asd"> Тарифы</li><li><img${ssrRenderAttr("src", $data.Arrow)} alt="asd"> Наши услуги</li><li><img${ssrRenderAttr("src", $data.Arrow)} alt="asd"> Наша команта</li><li><img${ssrRenderAttr("src", $data.Arrow)} alt="asd"> Отзывы клиентов</li><li><img${ssrRenderAttr("src", $data.Arrow)} alt="asd"> Контакты</li></ul></div><div class="footer-bottom-item"><h2> Полезное </h2><ul><li><img${ssrRenderAttr("src", $data.Arrow)} alt="asd"> Тарифы</li><li><img${ssrRenderAttr("src", $data.Arrow)} alt="asd"> Наши услуги</li><li><img${ssrRenderAttr("src", $data.Arrow)} alt="asd"> Наша команта</li><li><img${ssrRenderAttr("src", $data.Arrow)} alt="asd"> Отзывы клиентов</li><li><img${ssrRenderAttr("src", $data.Arrow)} alt="asd"> Контакты</li></ul></div></div></div></footer>`);
}
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-4b15e7d8>`);
      if (isMobile.value) {
        _push(`<button class="${ssrRenderClass([{ "active": isOpen.value }, "hamburger"])}" data-v-4b15e7d8>${ssrInterpolate(_ctx.$t("sidebar.mobile_menu"))}</button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="${ssrRenderClass([{ "mobile-open": isOpen.value }, "sidebar"])}" data-v-4b15e7d8><ul class="menu" data-v-4b15e7d8><li data-v-4b15e7d8>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(User), { class: "icon" }, null, _parent2, _scopeId));
            _push2(` ${ssrInterpolate(_ctx.$t("sidebar.profile"))}`);
          } else {
            return [
              createVNode(unref(User), { class: "icon" }),
              createTextVNode(" " + toDisplayString$1(_ctx.$t("sidebar.profile")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</li><span class="divider" data-v-4b15e7d8></span><li data-v-4b15e7d8>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: unref(localePath)("/parcels"),
        "active-class": "active",
        onClick: handleMobileClick
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Package), { class: "icon" }, null, _parent2, _scopeId));
            _push2(` ${ssrInterpolate(_ctx.$t("sidebar.parcels"))}`);
          } else {
            return [
              createVNode(unref(Package), { class: "icon" }),
              createTextVNode(" " + toDisplayString$1(_ctx.$t("sidebar.parcels")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(`</li><span class="divider" data-v-4b15e7d8></span><li data-v-4b15e7d8>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: unref(localePath)("/address"),
        "active-class": "active",
        onClick: handleMobileClick
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(MapPin), { class: "icon" }, null, _parent2, _scopeId));
            _push2(` ${ssrInterpolate(_ctx.$t("sidebar.addresses"))}`);
          } else {
            return [
              createVNode(unref(MapPin), { class: "icon" }),
              createTextVNode(" " + toDisplayString$1(_ctx.$t("sidebar.addresses")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</li><span class="divider" data-v-4b15e7d8></span></ul><ul class="menu" data-v-4b15e7d8><li data-v-4b15e7d8>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Settings), { class: "icon" }, null, _parent2, _scopeId));
            _push2(` ${ssrInterpolate(_ctx.$t("sidebar.settings"))}`);
          } else {
            return [
              createVNode(unref(Settings), { class: "icon" }),
              createTextVNode(" " + toDisplayString$1(_ctx.$t("sidebar.settings")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</li><span class="divider" data-v-4b15e7d8></span><li data-v-4b15e7d8><button class="logout-btn" data-v-4b15e7d8>`);
      _push(ssrRenderComponent(unref(LogOut), { class: "icon" }, null, _parent));
      _push(` ${ssrInterpolate(_ctx.$t("sidebar.logout"))}</button></li></ul></div></div>`);
    };
  }
};
...
const Sidebar = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-4b15e7d8"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="abu-express-wrapper"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "abu-express-wrapper" }, [
                showSidebar.value ? (openBlock(), createBlock(Sidebar, { key: 0 })) : createCommentVNode("", true),
...
export { Exit as E, _export_sfc as _, __nuxt_component_0 as a, useLocalePath as b, defineNuxtRouteMiddleware as d, navigateTo as n, server as s, tryUseNuxtApp as t, useI18n as u };
