...
<!--const authRoutes = ['/login', '/registration']; // Страницы, где Navbar и Footer не должны отображаться-->

<!--// Показываем Sidebar только если текущий путь в списке sidebarRoutes-->
