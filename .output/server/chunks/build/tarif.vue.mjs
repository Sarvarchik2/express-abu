...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  ssrRenderList($data.tarifs, (tarif2, index) => {
    ...
    if (tarif2.isModalOpen) {
      _push(`<div class="tarif-more-modal"><div class="tarif-more-modal-wrapper"><div class="tarif-more-modal-top"><h2>${ssrInterpolate(_ctx.$t("tarif_title"))}</h2><img${ssrRenderAttr("src", $data.Exit)} alt="exit"></div><p>${ssrInterpolate(_ctx.$t("tarif_description"))}</p></div></div>`);
    } else {
      _push(`<!---->`);
    }
